	...
	var Sortable = _react2['default'].createClass({
	  ...
	  renderItems: function renderItems() {
	    ...
	    var items = _orderArr.map(function (itemIndex, index) {
	      ...
	      var itemClassName = 'ui-sortable-item ' + (isPlaceHolder && 'ui-sortable-placeholder') + ' ' + (_this3.state.isDragging && isPlaceHolder && 'visible');
...
;
},{"react":158,"react-dom":29}],29:[function(require,module,exports){
'use strict';
...
var SortableItem = React.createClass({
    ...
    render: function () {
        return this.renderWithSortable(React.createElement(
            'div',
            { className: 'sorted', onClick: this.clickHandle },
            'item No: ',
            this.props.sortData
        ));
    }
...
var SortableContainer = React.createClass({
    ...
    render: function () {
        return this.renderWithSortable(React.createElement(
            ...
            React.createElement(
                Sortable,
                { className: 'region-sort', onSort: handleSort },
                React.createElement(SortableItem, { sortData: '1' }),
                React.createElement(SortableItem, { sortData: '2' }),
                React.createElement(SortableItem, { sortData: '3' })
            )
        ));
    }
});
...
ReactDOM.render(React.createElement(
    Sortable,
    null,
    React.createElement(SortableContainer, { sortData: 'container ONE' }),
    React.createElement(SortableContainer, { sortData: 'container TWO' })
), document.getElementById('content'));

},{"react":158,"react-anything-sortable":28,"react-dom":29}],160:[function(require,module,exports){
